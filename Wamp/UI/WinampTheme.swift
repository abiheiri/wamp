...
final class WinampTheme {
    ...
    // MARK: - EQ Sliders
    static let eqSliderBgTop = NSColor(hex: 0x36365A)
    static let eqSliderBgBottom = NSColor(hex: 0x2A2A44)
    static let eqSliderTick = NSColor(hex: 0x40405E)
    static let eqSliderCenter = NSColor(hex: 0x4A4A68)
    static let eqThumbTop = NSColor(hex: 0xC0C8D0)
    static let eqThumbMid = NSColor(hex: 0x8898A8)
    static let eqThumbBottom = NSColor(hex: 0x606878)
    static let eqThumbBorderLight = NSColor(hex: 0xD8E0E8)
    static let eqThumbBorderDark = NSColor(hex: 0x3A4050)
    static let eqFillStart = NSColor(hex: 0x2A6A10)
    static let eqFillEnd = NSColor(hex: 0x4A8A20)
    static let eqTrackBackground = NSColor(hex: 0x1A1A2C)
    static let eqBandLabelColor = NSColor(hex: 0x7A8A9A)
    static let eqDbLabelColor = NSColor(hex: 0x6A7A8A)
